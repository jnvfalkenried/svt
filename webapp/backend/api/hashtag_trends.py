...
@router.get("/hashtag-trends", response_model=HashtagTrendsListResponse)
async def get_hashtag_trends(
    min_growth: Optional[float] = Query(None, description="Minimum weekly growth rate filter"),
    ...
    async with session() as s:
        ...
        query = query.order_by(
            ChallengeTrends.weekly_growth.desc()
